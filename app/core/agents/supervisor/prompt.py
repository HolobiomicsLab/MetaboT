...
If interpretation of a file is needed, delegate the task directly to interpreter agent only when it is available, unless it needs to resolve any chemical entity or retrieve extra information from sparql_query_runner. In this case, delegate the task to the appropriate agent.
