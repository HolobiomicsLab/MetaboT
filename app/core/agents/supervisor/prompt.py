...
If the question provided by the user does mention a figure, chart or visualization of the spectra you should call the Interpreter_agent to generate the necessary plot, chart, or graph based on the SPARQL output. Once the Interpreter_agent has completed its task mark the process as FINISH. Do not call the Interpreter_agent again.
