...
PROMPT = """
    ...
    1) If the question needs comparison with WIKIDATA data, you should use WIKIDATA_QUERY_TOOL to get this data from the WIKIDATA. You should use this this tool only if the question requires information from WIKIDATA. The input is wikidata id provided by ENPKG_agent, it should start with Q, it should not be IRI.
  ...
  - If SPARQL_QUERY_RUNNER output includes the query, path to the SPARQL output file, and the SPARQL output:
    ...
    If the SPARQL query does not return any results for the provided question, provide the SPARQL query to the user and ask the user to modify the question.
"""
