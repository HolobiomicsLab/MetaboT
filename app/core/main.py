...
def main():
    ...
    q77 = "Which chemical compounds from Tabernaemontana coffeoides extract have the same SIRIUS and ISDB  annotations in positive and negative ionization mode? Provide the Inchikeys of 10 compounds. "
    q78 = "Which chemical compounds demonstrated inhibition rates above 50% against Trypanosoma cruzi target? Provide the Inchikeys of 10 compounds. "
    q79 = "Provide chemical compounds that have reported ChEMBL activity with activity type IC50 and activity values below 500 nM against Leishmania donovani target. Provide the Inchikeys of 10 compounds."
    q80 = "Which chemical compounds have been observed both in ChEMBL documents and in SIRIUS structural annotations within lab extracts. Provide the Inchikeys of 10 compounds."
    ...
    q86 = "What are the InChIKeys and corresponding Wikidata IDs of chemical entities associated with LCMS features in positive ionization mode that have an ISDB annotation and a feature area greater than 1,000,000? List the top 10 results in descending order by feature area."
    ...
    q94 = "List the chemical compounds from Tabernaemontana coffeoides that have both ISDB and SIRIUS structural annotations matching a retention time of less than 5 minutes. Provide the InChIKeys and corresponding Wikidata IDs of 10 compounds."
    q97 = "Which chemical compounds are detected in positive ionization mode from Tabernaemontana coffeoides? Provide the InChIKeys and corresponding Wikidata Ids of 10 compounds."
    ...
    q99_bis = "What are the InChIKeys and their corresponding Wikidata IDs for chemical entities annotated by ISDB in the lab extracts of Desmodium heterophyllum?"
    process_workflow(workflow, q99_bis)
